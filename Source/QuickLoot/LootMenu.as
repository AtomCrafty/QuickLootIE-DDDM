[InspectableList("textColorStringDefault", "textColorStringStealing")]
class QuickLoot.LootMenu extends gfx.core.UIComponent
{
	...
	[Inspectable(name="default text color", defaultValue="0xFFCC99")]
	private var textColorStringDefault: String = "0xFFCC99";
	[Inspectable(name="stealing text color", defaultValue="0xEF9A9A")]
	private var textColorStringStealing: String = "0xEF9A9A";
	
	public var textColorDefault: Number;
	public var textColorStealing: Number;
